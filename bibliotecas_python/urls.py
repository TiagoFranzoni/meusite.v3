...
from bibliotecas_python.views import BibliotecasDetail, Home, AdicionaBibliotecas, ExcluiBibliotecas, EditaBibliotecas
from bibliotecas_python.views import Login, CriaUsuario
from bibliotecas_python.views import BibliotecasList
# from bibliotecas_python.views import BibliotecasView
...
urlpatterns = [
    ...
    path('bibliotecas/', BibliotecasList.as_view(), name="biblioteca-list"),
